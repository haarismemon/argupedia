    ...
    <div>
      ...
      {props.showCriticalQuestions ?
        <div>
          ...
          <ul>
            <li><CriticalQuestion question={`Is the current circumstance '${props.circumstance}' true?`} argumentId={props._id} originalId={props.originalId} /></li>
            <li><CriticalQuestion question={`Does the action '${props.action}' achieve the goal of '${props.goal}'?`} argumentId={props._id} originalId={props.originalId}/></li>
            <li><CriticalQuestion question={`Is there an alternative action that achieves the goal '${props.goal}'?`} argumentId={props._id} originalId={props.originalId}/></li>
          </ul>
        </div>
        : null
      }
